...
COIN_DAEMON='/root/Masternodes/drip-1.0.2/bin/dripd'
COIN_CLI='/root/Masternodes/drip-1.0.2/bin/drip-cli'
COIN_DAEMON2='dripd'
COIN_CLI2='drip-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/DRIP-Project/DRIP/releases/download/v1.0.2.4/drip-1.0.2-x86_64-linux-gnu.tar.gz'
COIN_ZIP='/root/Masternodes/drip-1.0.2-x86_64-linux-gnu.tar.gz'
COIN_NAME='drip'
COIN_NAME2='drip2'
COIN_NAME3='drip3'
COIN_PORT=21461
