...
CONFIGFOLDER2='/root/.bhash2'
CONFIGFOLDER3='/root/.bhash3'
COIN_DAEMON='/root/Masternodes/BTCmonster/bhashd'
COIN_CLI='/root/Masternodes/BTCmonster/bhash-cli'
COIN_DAEMON2='bhashd'
COIN_CLI2='bhash-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/bhashcoin/bhash/releases/download/v2.0.4.2/bhash-2.0.4.2-linux.tar.gz'
COIN_ZIP='/root/Masternodes/bhash-2.0.4.2-linux.tar.gz'
COIN_NAME='Bhash1'
COIN_NAME2='Bhash2'
COIN_NAME3='Bhash3'
COIN_PORT=17652
