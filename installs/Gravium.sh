...
CONFIG_FILE='gravium.conf'
CONFIGFOLDER='/root/.graviumcore'
CONFIGFOLDER2='/root/.graviumcore2'
CONFIGFOLDER3='/root/.graviumcore3'
COIN_DAEMON='/root/Masternodes/graviumcore-1.0.1/bin/graviumd'
COIN_CLI='/root/Masternodes/graviumcore-1.0.1/bin/gravium-cli'
COIN_DAEMON2='graviumd'
COIN_CLI2='gravium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Gravium/gravium/releases/download/v1.0.1/graviumcore-1.0.1-linux64.tar.gz'
COIN_ZIP='/root/Masternodes/graviumcore-1.0.1-linux64.tar.gz'
COIN_NAME='Gravium'
COIN_NAME2='Gravium2'
COIN_NAME3='Gravium3'
COIN_PORT=11010
...
libboost-program-options-dev autotools-dev libboost-system-dev libboost-test-dev libboost-thread-dev sudo automake git curl libdb4.8-dev \
