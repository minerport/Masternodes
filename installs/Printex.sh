...
COIN_DAEMON='/root/Masternodes/printexd'
COIN_CLI='/root/Masternodes/printex-cli'
COIN_DAEMON2='printexd'
COIN_CLI2='printex-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Printex-official/printex-core/releases/download/v1.0.0.0/lin-daemon.zip'
COIN_ZIP='/root/Masternodes/lin-daemon.zip'
COIN_NAME='printex'
COIN_NAME2='printex2'
COIN_NAME3='printex3'
COIN_PORT=9797
