...
CONFIG_FILE='elli.conf'
CONFIGFOLDER='/root/.elli'
CONFIGFOLDER2='/root/.elli2'
CONFIGFOLDER3='/root/.elli3'
COIN_DAEMON='/root/Masternodes/elli-0.9.14/bin/ellid'
COIN_CLI='/root/Masternodes/elli-0.9.14/bin/elli-cli'
COIN_DAEMON2='ellid'
COIN_CLI2='elli-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/elliotproject/elli/releases/download/v0.9.14/elli-0.9.14-x86_64-linux-gnu.tar.gz'
COIN_ZIP='/root/Masternodes/elli-0.9.14-x86_64-linux-gnu.tar.gz'
COIN_NAME='Elliot'
COIN_NAME2='Elliot2'
COIN_NAME3='Elliot3'
COIN_PORT=61317
