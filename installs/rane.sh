...
CONFIGFOLDER2='/root/.ranecore2'
CONFIGFOLDER3='/root/.ranecore3'
COIN_DAEMON='/root/Masternodes/raned'
COIN_CLI='/root/Masternodes/rane-cli'
COIN_DAEMON2='raned'
COIN_CLI2='rane-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CryptoRane/Rane/releases/download/V1.0.0/linux.binary.zip'
COIN_ZIP='/root/Masternodes/linux.binary.zip'
COIN_NAME='Rane'
COIN_NAME2='Rane2'
COIN_NAME3='Rane3'
COIN_PORT=3268
