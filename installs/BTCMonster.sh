...
COIN_DAEMON='/root/Masternodes/BTCmonster/bitcoinmonsterd'
COIN_CLI='/root/Masternodes/BTCmonster/bitcoinmonster-cli'
...
COIN_ZIP='/root/Masternodes/btcmonster-linux.zip'
