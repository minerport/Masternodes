...
COIN_DAEMON='/root/Masternodes/installs/Rabbitd'
COIN_CLI='/root/Masternodes/installs/Rabbit-cli'
...
COIN_ZIP='/root/Masternodes/installs/RabbitCore-v1.0.2.2-linux64.tar.gz'
COIN_NAME='rabbit'
COIN_NAME2='rabbit2'
COIN_NAME3='rabbit3'
COIN_PORT=1128
