...
CONFIG_FILE='glyno.conf'
CONFIGFOLDER='/root/.glyno'
CONFIGFOLDER2='/root/.glyno2'
CONFIGFOLDER3='/root/.glyno3'
COIN_DAEMON='/root/Masternodes/glyno/glynod'
COIN_CLI='/root/Masternodes/glyno/glyno-cli'
COIN_DAEMON2='glynod'
COIN_CLI2='glyno-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/GlynoD/wallet/releases/download/v1.0.0/glyno-wallet-linux.tar'
COIN_ZIP='/root/Masternodes/glyno-wallet-linux.tar'
COIN_NAME='glyno'
COIN_NAME2='glyno2'
COIN_NAME3='glyno3'
COIN_PORT=7442
...
addnode=107.172.9.103
addnode=72.11.129.12
addnode=107.172.6.82
EOF
}
