...
CONFIG_FILE='reef.conf'
CONFIGFOLDER='/root/.reefcore'
CONFIGFOLDER2='/root/.reefcore2'
CONFIGFOLDER3='/root/.reefcore3'
COIN_DAEMON='/root/Masternodes/reef_1.2.1_linux/reefd'
COIN_CLI='/root/Masternodes/reef_1.2.1_linux/reef-cli'
COIN_DAEMON2='reefd'
COIN_CLI2='reef-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/reefcore/ReefCoin/releases/download/1.2.1/reef_1.2.1_linux.tar.gz'
COIN_ZIP='/root/Masternodes/reef_1.2.1_linux.tar.gz'
COIN_NAME='reef'
COIN_NAME2='reef2'
COIN_NAME3='reef3'
COIN_PORT=9857
