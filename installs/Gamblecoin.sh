...
COIN_TGZ='https://github.com/GambleCoin-Project/GambleCoin/releases/download/1.1.4/gamblecoin-1.1.4-x86_64-linux-gnu.tar.gz'
COIN_ZIP='/root/Masternodes/gamblecoin-1.1.4-x86_64-linux-gnu.tar.gz'
COIN_NAME='gamble'
COIN_NAME2='gamble2'
COIN_NAME3='gamble3'
COIN_PORT=12000
