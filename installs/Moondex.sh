...
COIN_DAEMON='/root/Masternodes/installs/moondexd'
COIN_CLI='/root/Masternodes/installs/moondex-cli'
...
COIN_ZIP='/root/Masternodes/installs/linux-no-gui-v2.0.1.1.tar.gz'
COIN_NAME='mdex'
COIN_NAME2='mdex2'
COIN_NAME3='mdex3'
COIN_PORT=8906
...
echo "*/15 * * * * /root/mdex-ip-install/mnchecker >> /root/Masternodes/installs//checker.log 2>&1" >> tempcron
...
echo "*/15 * * * * /root/mdex-ip-install/mnchecker2 >> /root/Masternodes/installs/checker2.log 2>&1" >> tempcron
...
echo "*/15 * * * * /root/mdex-ip-install/mnchecker3 >> /root/Masternodes/installs/checker3.log 2>&1" >> tempcron
}
